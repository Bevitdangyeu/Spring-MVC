...
public class ProductAPI {
	...
	@PostMapping("/add")
	public ProductDTO create(  @RequestParam("jsonData") String jsonData,@RequestParam("image") MultipartFile fileFromClient,@RequestParam("listImage") MultipartFile[] Listfiles) throws JsonMappingException, JsonProcessingException {
